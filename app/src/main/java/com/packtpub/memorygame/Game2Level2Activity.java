...
public class Game2Level2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initGame(){
        ...
        if (isTimeTrialGame) {
            textTime.setText("Time: " + cardTools.secondsToStrTime(SECONDS_GAME2_LEVEL1 + SECONDS_INCREMENT_BETWEEN_LEVELS + bonusTime));
            initialTimeMilis = (SECONDS_GAME2_LEVEL1 + SECONDS_INCREMENT_BETWEEN_LEVELS + bonusTime) * 1000;
            Log.i(TAG, "...initGame...initTime = " + SECONDS_GAME2_LEVEL1 + " + " + SECONDS_INCREMENT_BETWEEN_LEVELS + " + " + bonusTime);
        }
    ...
    private void saveResult() {
        ...
        SharedPreferences prefs = getSharedPreferences(game2Level2BestScore, MODE_PRIVATE);

        //Load existing Best Score or if it is not available default (0)
        int bestScore = prefs.getInt(game2Level2BestScore, 0);
        ...
        if (score > bestScore) {
            ...
            editor.putInt(game2Level2BestScore, score);
            editor.commit();
